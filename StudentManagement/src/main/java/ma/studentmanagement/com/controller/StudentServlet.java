...
public class StudentServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			case "/delete":
				...
				break;
			case "/searche":
				listStudentSEARCH(request, response);
				break;
			case "/edit":
	...
	private void listStudentSEARCH(HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException, ServletException {
		String SEARCHEname = request.getParameter("SEARCHEname");
		
		List<Student> listStudent = studentDao.selectStudentCHERCHER(SEARCHEname);
